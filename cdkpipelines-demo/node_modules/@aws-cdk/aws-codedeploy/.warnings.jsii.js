...
function _aws_cdk_aws_codedeploy_CfnDeploymentGroupProps(p) {
    ...
    if (!visitedObjects.has(p.alarmConfiguration))
        _aws_cdk_aws_codedeploy_CfnDeploymentGroup_AlarmConfigurationProperty(p.alarmConfiguration);
    visitedObjects.delete(p);
}
